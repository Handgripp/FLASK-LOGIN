...
def register_routes(app):
    ...
    app.route('/user/<id>', methods=['GET'])(get_one_user)
    app.route('/user', methods=['POST'])(create_user)
    app.route('/user/<id>', methods=['PUT'])(promote_user)
    app.route('/user/<id>', methods=['DELETE'])(delete_user)
    ...
    app.route('/todo/<todo_id>', methods=['PUT'])(update_todo)
